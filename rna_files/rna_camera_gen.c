...
BoolPropertyRNA rna_Camera_show_title_safe;
...
BoolPropertyRNA rna_Camera_show_limits = {
	{(PropertyRNA *)&rna_Camera_show_mist, (PropertyRNA *)&rna_Camera_dof_distance,
...
BoolPropertyRNA rna_Camera_show_passepartout = {
	{(PropertyRNA *)&rna_Camera_show_title_safe, (PropertyRNA *)&rna_Camera_show_mist,
...
BoolPropertyRNA rna_Camera_show_title_safe = {
	{(PropertyRNA *)&rna_Camera_show_name, (PropertyRNA *)&rna_Camera_show_passepartout,
	-1, "show_title_safe", 3, "Show Safe Areas",
	"Show TV title safe and action safe zones in Camera view",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 85393408, NULL, NULL,
	0, -1, NULL},
	Camera_show_title_safe_get, Camera_show_title_safe_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Camera_show_name = {
	{(PropertyRNA *)&rna_Camera_show_sensor, (PropertyRNA *)&rna_Camera_show_title_safe,
...
EnumPropertyRNA rna_Camera_lens_unit = {
	{(PropertyRNA *)&rna_Camera_animation_data, (PropertyRNA *)&rna_Camera_show_sensor,
...
PointerPropertyRNA rna_Camera_animation_data = {
	{(PropertyRNA *)&rna_Camera_dof_object, (PropertyRNA *)&rna_Camera_lens_unit,
...
PointerPropertyRNA rna_Camera_dof_object = {
	{NULL, (PropertyRNA *)&rna_Camera_animation_data,
...
StructRNA RNA_Camera = {
	{(ContainerRNA *)&RNA_ClothSettings, (ContainerRNA *)&RNA_OperatorStrokeElement,
	NULL,
	{(PropertyRNA *)&rna_Camera_type, (PropertyRNA *)&rna_Camera_dof_object}},
