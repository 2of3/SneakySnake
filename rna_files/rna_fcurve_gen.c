...
FunctionRNA rna_FCurve_update_autoflags_func = {
	{NULL, (FunctionRNA *)&rna_FCurve_range_func,
	NULL,
...
StructRNA RNA_FCurve = {
	...
	NULL,
	NULL,
	{(FunctionRNA *)&rna_FCurve_evaluate_func, (FunctionRNA *)&rna_FCurve_update_autoflags_func}
};
...
static EnumPropertyItem rna_DriverTarget_id_type_items[32] = {
...
EnumPropertyRNA rna_DriverTarget_id_type = {
	...
	0, -1, NULL},
	DriverTarget_id_type_get, DriverTarget_id_type_set, NULL, NULL, NULL, NULL, rna_DriverTarget_id_type_items, 31, 16975
};
